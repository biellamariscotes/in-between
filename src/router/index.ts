    ...
    children: [
      {
        ...
        meta: { title: 'In-Between', style: 'landing.css', requireGuest: true },
      },
      {
        path: '/choose-player',
        name: 'choose-player',
        component: () => import('@/views/registration/ChoosePlayerView.vue'),
        meta: { title: 'Choose Player', style: 'choosePlayer.css', requireGuest: true },
      },
      {
        path: '/registration',
        name: 'registration',
        component: () => import('@/views/registration/RegistrationView.vue'),
        meta: { title: 'Register Player', style: 'registration.css', requireGuest: true },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        meta: { title: 'In-Between', style: 'gameZone.css', requireGuest: true },
      },
    ],
  },
